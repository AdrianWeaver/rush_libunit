...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/28 09:52:00 by aweaver           #+#    #+#             */
/*   Updated: 2022/01/28 09:52:13 by aweaver          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	test_u08(void)
{
	...
	while (i < 7)
	{
		list.ret_ptf = sprintf(list.ptf_str, "%%u%u", tab[i]);
		ft_pipe_stdout(pipefd);
		list.ret_ft = ft_printf("%%u%u", tab[i]);
