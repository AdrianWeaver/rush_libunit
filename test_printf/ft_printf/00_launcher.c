...
/*   Updated: 2022/01/23 22:30:33 by aweaver          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_printf_launcher(void)
{
	...
	t_ft_ptf = t_start;
	(void)t_ft_ptf;
	t_ft_ptf = ft_test_lst_new("ft_printf", "%1c", &test_1c, t_ft_ptf);
	t_ft_ptf = ft_test_lst_new("ft_printf", "%42c", &test_42c, t_ft_ptf);
	...
	//ft_lstclear(&t_start, &free); //not needed anymore since launcher deals with this.
	return (ret);
}
