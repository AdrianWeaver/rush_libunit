...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/24 11:09:36 by aweaver           #+#    #+#             */
/*   Updated: 2022/01/24 14:29:04 by aweaver          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	test_s07(void)
{
	...
	while (i < 8)
	{
		list.ret_ptf = sprintf(list.ptf_str, "s\33%s\t", tab[i]);
		ft_pipe_stdout(pipefd);
		list.ret_ft = ft_printf("s\33%s\t", tab[i]);
